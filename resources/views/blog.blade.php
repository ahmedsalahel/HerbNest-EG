...
<section class="page-header"
    style="background-image: url({{ asset('allAssets/web/assets/images/backgrounds/page-header-contact.webp') }});">
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-4">
                ...
                <div class="blog_one_single wow fadeInLeft" data-wow-duration="1500ms" data-wow-delay="0ms">
                    <div class="blog_one_image">
                        <img src="{{ asset('allAssets/web/assets/images/blog/blog--page-img-1.webp') }}" alt="">
            ...
            <div class="col-xl-4 col-lg-4">
                ...
                <div class="blog_one_single wow fadeInDown" data-wow-duration="1500ms" data-wow-delay="100ms">
                    <div class="blog_one_image">
                        <img src="{{ asset('allAssets/web/assets/images/blog/blog--page-img-2.webp') }}" alt="">
                        <div class="blog_one_date_box">
                            <p>20 <br> Oct</p>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-lg-4">
                ...
                <div class="blog_one_single wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="200ms">
                    <div class="blog_one_image">
                        <img src="{{ asset('allAssets/web/assets/images/blog/blog--page-img-3.webp') }}" alt="">
                        <div class="blog_one_date_box">
                            <p>20 <br> Oct</p>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-lg-4">
                ...
                <div class="blog_one_single wow fadeInRight" data-wow-duration="1500ms" data-wow-delay="300ms">
                    <div class="blog_one_image">
                        <img src="{{ asset('allAssets/web/assets/images/blog/blog--page-img-4.webp') }}" alt="">
                        <div class="blog_one_date_box">
                            <p>20 <br> Oct</p>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-lg-4">
                ...
                <div class="blog_one_single wow fadeInDown" data-wow-duration="1500ms" data-wow-delay="400ms">
                    <div class="blog_one_image">
                        <img src="{{ asset('allAssets/web/assets/images/blog/blog--page-img-5.webp') }}" alt="">
                        <div class="blog_one_date_box">
                            <p>20 <br> Oct</p>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-lg-4">
                ...
                <div class="blog_one_single wow fadeInRight" data-wow-duration="1500ms" data-wow-delay="500ms">
                    <div class="blog_one_image">
                        <img src="{{ asset('allAssets/web/assets/images/blog/blog--page-img-6.webp') }}" alt="">
                        <div class="blog_one_date_box">
                            <p>20 <br> Oct</p>
                        </div>
                    </div>
