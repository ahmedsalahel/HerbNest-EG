                ...
                <div class="card-body pa-0">
                    ...
                    <div class="progress-wrap">
                        <div class="progress rounded-bottom-left rounded-bottom-right">
                            ...
                            <div class="progress-bar bg-neon-light-1 w-35" role="progressbar" aria-valuenow="35"
                                aria-valuemin="0" aria-valuemax="100"></div>
                            <div class="progress-bar bg-neon-light-2 w-50" role="progressbar" aria-valuenow="50"
                                aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="hk-legend-wrap mt-10">
                                <div class="hk-legend">
                                    <span
                                        class="d-10 bg-primary rounded-circle d-inline-block"></span><span>Desktop</span>
                                </div>
                                <div class="hk-legend">
                                    <span
                                ...
                                <div class="hk-legend">
                                    <span
                                        class="d-10 bg-neon-light-2 rounded-circle d-inline-block"></span><span>Tablet</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="hk-legend-wrap mt-10">
                                <div class="hk-legend">
                                    <span
                                        class="d-10 bg-primary rounded-circle d-inline-block"></span><span>Today</span>
                                </div>
                                <div class="hk-legend">
                                    <span
                                        class="d-10 bg-neon-light-1 rounded-circle d-inline-block"></span><span>Yesterday</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="table-wrap">
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <tr>
                                <td><img class="circle" src="{{ asset('allAssets/dash/dist/img/logo5.jpg') }}"
                                        alt="icon"></td>
                                <td>Fakebook</td>
                                <td><span class="peity-line" data-width="90"
                                        data-peity='{ "fill": ["rgba(102,64,178,.05)"], "stroke":["#6640b2"]}'
                                        data-height="40">1,6,6,9,7,4,8,5,2,1</span> </td>
                            ...
                            <tr>
                                <td><img class="circle" src="{{ asset('allAssets/dash/dist/img/logo2.jpg') }}"
                                        alt="icon"></td>
                                <td>Microhard</td>
                                <td><span class="peity-line" data-width="90"
                                        data-peity='{ "fill": ["rgba(102,64,178,.05)"], "stroke":["#6640b2"]}'
                                        data-height="40">1,6,6,9,9,9,8,5,2,1</span> </td>
                                <td><span class="text-danger"><i class="ion ion-md-arrow-down" aria-hidden="true"></i> $
                                        7,181</span> </td>
                                <td><span class="text-danger"><i class="ion ion-md-arrow-down" aria-hidden="true"></i> $
                                        9,202</span> </td>
                            ...
                            <tr>
                                <td><img class="circle" src="{{ asset('allAssets/dash/dist/img/logo3.jpg') }}"
                                        alt="icon"></td>
                                <td>Oesla Motors</td>
                                <td><span class="peity-line" data-width="90"
                                        data-peity='{ "fill": ["rgba(102,64,178,.05"], "stroke":["#6640b2"]}'
                                        data-height="40">5,6,5,5,7,4,6,5,2,1</span> </td>
                                <td><span class="text-success"><i class="ion ion-md-arrow-up" aria-hidden="true"></i> $
                                        9,303</span> </td>
                                <td><span class="text-danger"><i class="ion ion-md-arrow-down" aria-hidden="true"></i> $
                                        1,323</span> </td>
                            ...
                            <tr>
                                <td><img class="circle" src="{{ asset('allAssets/dash/dist/img/logo4.jpg') }}"
                                        alt="icon"></td>
                                <td>NVISION</td>
                                <td><span class="peity-line" data-width="90"
                                        data-peity='{ "fill": ["rgba(50,65,72,.05"], "stroke":["#6640b2"]}'
                                        data-height="40">3,4,4,6,4,4,7,5,2,1</span> </td>
                                <td><span class="text-success"><i class="ion ion-md-arrow-up" aria-hidden="true"></i> $
                                        1,424</span> </td>
                                <td><span class="text-danger"><i class="ion ion-md-arrow-down" aria-hidden="true"></i> $
                                        3,444</span> </td>
